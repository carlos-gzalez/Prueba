...
<body background="images\b1.jpg" style=" margin-top: 85px;">
    ...
    <div class="bg-dark">
        ...
        <!-- Footer -->
        <footer class="footer ">
            <div class="card text-center" style="background-color: #07041E">
                <div class="card-body">
                    <h5 class="card-title text-white">RETRO PRO</h5>
                </div>
