        ...
        @csrf
            <div class="form-row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="marca" class="form-control" id="validationCustom02" placeholder="marca" value="" required>
                    <div class="valid-feedback">
                        Looks good!
                    </div>
                </div>
            ...
            <div class="form-row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="stock" class="form-control" id="validationCustom04" placeholder="stock" required>
                    <div class="invalid-feedback">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="costo" class="form-control" id="validationCustom05" placeholder="costo" required>
                    <div class="invalid-feedback">
